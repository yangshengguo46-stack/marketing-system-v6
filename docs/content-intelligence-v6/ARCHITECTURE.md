...
4. 共同世界工作者比较业务直接实践与经筛选的语义家族，只能提出一条可空的共同世界及其逐步意义路径。语义家族合成时只看独立意义成分与分支，不接收该成分在原复合词中的用途解释，避免“礼在礼品里表示赠礼”一类近商品含义提前占满注意力。供应商结构先被容纳和清洗，再由确定性归一化检查世界、路径和构成语境；材质或样式误填不会拖垮有效世界，真正改变人物、共同事件、关系或生命周期的修饰语若未被独立保留，该共同世界仍撤下而不是强行补齐。
