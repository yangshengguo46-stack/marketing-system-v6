...
4. 共同世界工作者比较业务直接实践与经筛选的语义家族，只能提出一条可空的共同世界及其逐步意义路径；构成修饰语若未被独立保留，该共同世界撤下而不是强行补齐。
5. 独立反事实复核者只检查这条意义路径是否解释得通、替换主词后是否仍成立；它不能生成新候选或自行选根。
6. 代码从原始对象、词法主词、语义成分、完整被服务对象、完整参与活动、功能和通过复核的共同世界装配候选。日常操作步骤与过窄场景可以标为 `example_branch`，无权成为根。
7. 单一根裁决器只看到冻结候选的名称与来源层级。它比较候选在真实内容世界中的外延容量：把场馆、对象、消费动作和社交结果拼成长名称不自动成为更大世界；若对象在该场景外仍能展开历史、人物、事件、地域或作品，场景只是对象地图的一条路径。
8. 地图专家只看冻结的 `content_root`，看不到商品、用户原话和销售目标。它在同一次调用中形成账号长期承诺、稳定观察方法、防漂移边界和内容疆域，不生成每日选题，也不选择表现形式。
