...
| `marketing-video-production`   | V6 video planning, benchmark-evidence review, asset routing, and unregistered provider handoff preparation |
| `video-generation`             | Disabled legacy direct-provider compatibility package                            |
