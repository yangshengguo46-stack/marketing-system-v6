...
async def branch_thread(thread_id: ThreadId, body: ThreadBranchRequest, request: Request) -> ThreadBranchResponse:
    ...
    if isinstance(source_project_id, str) and source_project_id:
        ...
        source_logical_account_id = source_metadata.get(INCUBATION_LOGICAL_ACCOUNT_ID_KEY)
        if isinstance(source_logical_account_id, str) and source_logical_account_id:
            branch_metadata[INCUBATION_LOGICAL_ACCOUNT_ID_KEY] = source_logical_account_id
