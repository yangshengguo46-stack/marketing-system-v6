...
_request_stable_client_token = request_stable_client_token
...
async def _get_client_token(client_key: str, client_secret: str) -> str:
    return await get_stable_client_token(
        client_key,
        client_secret,
        request_token=_request_stable_client_token,
    )


async def _invalidate_client_token(client_key: str, client_secret: str, access_token: str) -> None:
    await invalidate_stable_client_token(client_key, client_secret, access_token)
